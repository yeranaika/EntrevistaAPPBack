...
('PR', 'Analisis TI', 'jr', '¿Qué es un Requisito Funcional?', '["Describe lo que el sistema debe hacer", "Comportamiento"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Cómo se ve el sistema"},{"id":"B", "texto":"Una función o servicio que el sistema debe proveer"},{"id":"C", "texto":"La velocidad del sistema"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'jr', 'En un diagrama de flujo, ¿qué forma representa una decisión?', '["Tiene forma de diamante", "Suelen salir flechas de SI/NO"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Rectángulo"},{"id":"B", "texto":"Rombo/Diamante"},{"id":"C", "texto":"Círculo"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'jr', '¿Qué significan las siglas UML?', '["Lenguaje visual estándar", "Unified..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Universal Modeling List"},{"id":"B", "texto":"Unified Modeling Language"},{"id":"C", "texto":"User Management Logic"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'jr', 'Define brevemente qué es un "Stakeholder".', '["Interesado", "Puede afectar o ser afectado"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 200}'::jsonb),
('PR', 'Analisis TI', 'jr', '¿Cuál es el actor principal en un Caso de Uso de "Login"?', '["Quien inicia la acción", "Persona frente al PC"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Usuario"},{"id":"B", "texto":"Base de Datos"},{"id":"C", "texto":"Servidor"}], "respuesta_correcta":"A"}'::jsonb),
('PR', 'Analisis TI', 'jr', 'Diferencia principal entre Requisito Funcional y No Funcional.', '["El Qué vs el Cómo", "Calidad vs Comportamiento"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 300}'::jsonb),
('PR', 'Analisis TI', 'jr', 'En metodología Ágil, ¿quién suele priorizar el Backlog?', '["Representa al negocio", "Product..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Scrum Master"},{"id":"B", "texto":"Product Owner"},{"id":"C", "texto":"El Desarrollador"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'jr', '¿Qué es un "Bug"?', '["Error", "Fallo en el software"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 10, "max_caracteres": 150}'::jsonb),
('PR', 'Analisis TI', 'jr', '¿Para qué sirve una entrevista de levantamiento de información?', '["Técnica de educción", "Hablar con el cliente"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Para programar el código"},{"id":"B", "texto":"Para entender las necesidades del usuario"},{"id":"C", "texto":"Para vender el producto"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'jr', 'Menciona 3 técnicas para recopilar requisitos.', '["Entrevistas...", "Encuestas..."]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 200}'::jsonb),
('PR', 'Analisis TI', 'mid', 'Escribe el formato estándar de una Historia de Usuario.', '["Como [rol]...", "Quiero [acción]..."]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 200}'::jsonb),
('PR', 'Analisis TI', 'mid', '¿Qué diagrama UML usarías para mostrar los estados por los que pasa una orden de compra?', '["Inicio, Pendiente, Aprobado, Fin", "Máquina de..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Diagrama de Clases"},{"id":"B", "texto":"Diagrama de Estados"},{"id":"C", "texto":"Diagrama de Despliegue"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'mid', '¿Qué es el criterio de aceptación?', '["Condiciones para dar por terminada una tarea", "Definition of Done"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 40, "max_caracteres": 400}'::jsonb),
('PR', 'Analisis TI', 'mid', 'En BPMN, ¿qué representa un carril (Swimlane)?', '["Responsabilidad", "Actor o departamento"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Una decisión lógica"},{"id":"B", "texto":"Un actor o rol responsable de las tareas"},{"id":"C", "texto":"El flujo de datos"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'mid', 'Explica qué es la Trazabilidad de Requisitos.', '["Seguir la vida de un requisito", "Desde el origen hasta el código"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 500}'::jsonb),
('PR', 'Analisis TI', 'mid', '¿Cuál es la diferencia entre un prototipo de baja y alta fidelidad?', '["Papel vs Interactivo", "Detalle visual"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 300}'::jsonb),
('PR', 'Analisis TI', 'mid', '¿Qué es una prueba UAT?', '["User Acceptance Testing", "Prueba final"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Prueba Unitaria Automatizada"},{"id":"B", "texto":"Prueba de Aceptación de Usuario"},{"id":"C", "texto":"Prueba de Carga"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'mid', 'Si un requisito cambia a mitad del desarrollo en un entorno Waterfall, ¿qué suele pasar?', '["Control de cambios", "Costoso"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Se adapta inmediatamente sin costo"},{"id":"B", "texto":"Requiere un proceso formal de control de cambios y suele ser costoso"},{"id":"C", "texto":"Se ignora el cambio"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'mid', 'Describe el concepto de "Happy Path".', '["Camino ideal", "Sin errores"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 300}'::jsonb),
('PR', 'Analisis TI', 'mid', '¿Qué herramienta usarías para gestionar un Backlog?', '["Jira es la más famosa", "Trello"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Photoshop"},{"id":"B", "texto":"Jira / Azure PROps"},{"id":"C", "texto":"Visual Studio Code"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'sr', '¿Cómo manejas a un Stakeholder que insiste en un requisito técnicamente inviable?', '["Negociación", "Alternativas"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 100, "max_caracteres": 1000}'::jsonb),
('PR', 'Analisis TI', 'sr', 'Realiza un análisis de brechas (Gap Analysis) breve para la migración de un sistema legado a la nube.', '["Estado actual vs Estado futuro", "Identificar lo que falta"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 100, "max_caracteres": 1500}'::jsonb),
('PR', 'Analisis TI', 'sr', '¿Qué es la Deuda Técnica desde la perspectiva del Analista de Negocio?', '["Costo futuro", "Atajos tomados hoy"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Dinero que se debe al proveedor"},{"id":"B", "texto":"Costo implícito de retrabajo futuro por elegir una solución rápida hoy"},{"id":"C", "texto":"Falta de presupuesto"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'sr', 'Describe cómo priorizar requisitos usando la técnica MoSCoW.', '["Must, Should, Could, Won''t", "Esencial vs Deseable"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 600}'::jsonb),
('PR', 'Analisis TI', 'sr', 'En un proyecto crítico, ¿cómo mitigas el riesgo de "Scope Creep" (Alcance no controlado)?', '["Límites claros", "Proceso de cambios estricto"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 80, "max_caracteres": 800}'::jsonb),
('PR', 'Analisis TI', 'sr', 'Diferencia estratégica entre BPM (Business Process Management) y BPR (Business Process Reengineering).', '["Mejora continua vs Cambio radical", "Evolución vs Revolución"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"BPM es radical, BPR es incremental"},{"id":"B", "texto":"BPM es mejora continua, BPR es rediseño radical desde cero"},{"id":"C", "texto":"Son lo mismo"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Analisis TI', 'sr', '¿Qué valor aporta un Diagrama de Secuencia en la fase de diseño técnico?', '["Interacción entre objetos", "Tiempo y mensajes"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 500}'::jsonb),
('PR', 'Analisis TI', 'sr', 'Ante dos departamentos con requisitos contradictorios, ¿cuál es tu estrategia de resolución?', '["Facilitador", "Objetivos de negocio superiores"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 80, "max_caracteres": 1000}'::jsonb),
('PR', 'Analisis TI', 'sr', 'Explica el concepto de MVP (Producto Mínimo Viable) a un cliente que quiere "todo el sistema terminado ya".', '["Valor inmediato", "Aprendizaje validado"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 800}'::jsonb),
('PR', 'Analisis TI', 'sr', '¿Qué métrica utilizarías para evaluar la calidad de los requisitos definidos?', '["Tasa de defectos en requisitos", "Claridad y Completitud"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Líneas de código generadas"},{"id":"B", "texto":"Número de cambios solicitados post-aprobación (volatilidad)"},{"id":"C", "texto":"Horas de reunión"}], "respuesta_correcta":"B"}'::jsonb);

-- 2. ADMINISTRADOR DE EMPRESA (Código: PR)
INSERT INTO pregunta (tipo_banco, sector, nivel, texto, pistas, config_respuesta) VALUES
('PR', 'Administracion', 'jr', '¿Qué significa las siglas FODA?', '["Análisis estratégico", "Fortalezas..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Finanzas, Organización, Dirección, Administración"},{"id":"B", "texto":"Fortalezas, Oportunidades, Debilidades, Amenazas"},{"id":"C", "texto":"Fondo de Ahorro"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'jr', '¿Cuál es el objetivo principal de una empresa con fines de lucro?', '["Generar valor", "Rentabilidad"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Pagar impuestos"},{"id":"B", "texto":"Maximizar la riqueza de los accionistas/dueños"},{"id":"C", "texto":"Tener muchos empleados"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'jr', 'Define qué es un "Activo" en contabilidad.', '["Lo que tienes", "Recursos"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 200}'::jsonb),
('PR', 'Administracion', 'jr', '¿Qué documento muestra la estructura jerárquica de una empresa?', '["Mapa visual de cargos", "Árbol"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Balance General"},{"id":"B", "texto":"Organigrama"},{"id":"C", "texto":"Flujograma"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'jr', '¿Qué es la Eficacia?', '["Lograr el objetivo", "Diferente a Eficiencia"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 200}'::jsonb),
('PR', 'Administracion', 'jr', '¿Cuál es la función principal del departamento de Recursos Humanos?', '["Gestión de talento", "Contratación"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 200}'::jsonb),
('PR', 'Administracion', 'jr', 'En la mezcla de marketing (4P), ¿cuáles son las 4 P?', '["Producto...", "Precio..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Producto, Precio, Plaza, Promoción"},{"id":"B", "texto":"Personal, Proceso, Planta, Producción"},{"id":"C", "texto":"Planificación, Poder, Política, Prensa"}], "respuesta_correcta":"A"}'::jsonb),
('PR', 'Administracion', 'jr', '¿Qué significa B2B?', '["Tipo de comercio", "Business to..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Business to Business"},{"id":"B", "texto":"Business to Buyer"},{"id":"C", "texto":"Back to Basics"}], "respuesta_correcta":"A"}'::jsonb),
('PR', 'Administracion', 'jr', 'Define "Costos Fijos".', '["No varían con la producción", "Alquiler, sueldos base"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 20, "max_caracteres": 200}'::jsonb),
('PR', 'Administracion', 'jr', '¿Quién es la máxima autoridad formal en una Sociedad Anónima?', '["Representa a los accionistas", "Junta..."]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"El Gerente General"},{"id":"B", "texto":"La Junta de Accionistas"},{"id":"C", "texto":"El Contador"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'mid', 'Explica qué son los objetivos SMART.', '["Específicos, Medibles...", "Acrónimo en Inglés"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 40, "max_caracteres": 400}'::jsonb),
('PR', 'Administracion', 'mid', '¿Cuál es la diferencia entre Liderazgo Transaccional y Transformacional?', '["Intercambio vs Inspiración", "Premios vs Visión"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 500}'::jsonb),
('PR', 'Administracion', 'mid', '¿Qué mide el KPI "Rotación de Personal"?', '["Entradas y salidas", "Retención"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"La velocidad de trabajo"},{"id":"B", "texto":"El porcentaje de empleados que abandonan la organización en un periodo"},{"id":"C", "texto":"El cambio de puestos internos"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'mid', 'Calcula el Punto de Equilibrio si: Costos Fijos = 1000, Precio = 50, Costo Variable = 30.', '["Fórmula: CF / (P - CV)", "Margen de contribución es 20"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"20 unidades"},{"id":"B", "texto":"50 unidades"},{"id":"C", "texto":"100 unidades"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'mid', '¿Qué es un Diagrama de Gantt?', '["Gestión de proyectos", "Cronograma visual"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 300}'::jsonb),
('PR', 'Administracion', 'mid', '¿Qué estado financiero muestra la rentabilidad de la empresa en un periodo determinado?', '["Ingresos - Gastos", "Estado de Resultados"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Balance General"},{"id":"B", "texto":"Estado de Resultados (P&L)"},{"id":"C", "texto":"Flujo de Caja"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'mid', 'Define la técnica de feedback "Sandwich".', '["Positivo - Mejora - Positivo", "Suavizar la crítica"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 300}'::jsonb),
('PR', 'Administracion', 'mid', '¿Qué es el Clima Organizacional?', '["Percepción de los empleados", "Ambiente"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 300}'::jsonb),
('PR', 'Administracion', 'mid', '¿Cuál es la ventaja competitiva según Michael Porter?', '["Diferenciación o Costos", "Lo que te hace único"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Tener más dinero"},{"id":"B", "texto":"Una característica que permite superar a los rivales de manera sostenible"},{"id":"C", "texto":"Bajar los precios siempre"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'mid', 'En gestión de inventarios, ¿qué es el método FIFO?', '["Lo primero que entra...", "First In First Out"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Primero en Entrar, Primero en Salir"},{"id":"B", "texto":"Último en Entrar, Primero en Salir"},{"id":"C", "texto":"Promedio Ponderado"}], "respuesta_correcta":"A"}'::jsonb),
('PR', 'Administracion', 'sr', 'Describe las 5 Fuerzas de Porter.', '["Proveedores, Clientes, Nuevos entrantes...", "Rivalidad"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 100, "max_caracteres": 1000}'::jsonb),
('PR', 'Administracion', 'sr', '¿Cuál es la diferencia financiera entre CAPEX y OPEX?', '["Inversión vs Gasto operativo", "Largo plazo vs Día a día"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 600}'::jsonb),
('PR', 'Administracion', 'sr', 'En una fusión de empresas (M&A), ¿cuál es el mayor riesgo cultural?', '["Choque de culturas", "Resistencia al cambio"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Cambio de logo"},{"id":"B", "texto":"Pérdida de talento clave por choque cultural"},{"id":"C", "texto":"Aumento de capital"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'sr', 'Explica el concepto de "Balanced Scorecard" (Cuadro de Mando Integral).', '["Kaplan y Norton", "4 perspectivas"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 80, "max_caracteres": 800}'::jsonb),
('PR', 'Administracion', 'sr', '¿Cómo manejarías una reducción de personal del 20% para minimizar el impacto en la moral de los restantes?', '["Comunicación transparente", "Outplacement"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 100, "max_caracteres": 1500}'::jsonb),
('PR', 'Administracion', 'sr', '¿Qué es el EBITDA y por qué es importante para valorar una empresa?', '["Earnings Before...", "Operatividad pura"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Muestra la utilidad neta final"},{"id":"B", "texto":"Muestra la capacidad de generar efectivo operativo puro, sin impuestos ni intereses"},{"id":"C", "texto":"Es el total de ventas"}], "respuesta_correcta":"B"}'::jsonb),
('PR', 'Administracion', 'sr', 'Estrategia de Océano Azul: descríbela.', '["Crear nuevos mercados", "Hacer la competencia irrelevante"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 50, "max_caracteres": 600}'::jsonb),
('PR', 'Administracion', 'sr', 'En Responsabilidad Social Empresarial (RSE), ¿qué es el concepto de "Triple Bottom Line"?', '["Personas, Planeta, Beneficio", "3P"]'::jsonb, '{"tipo": "seleccion_unica", "opciones": [{"id":"A", "texto":"Social, Ambiental, Económico"},{"id":"B", "texto":"Ventas, Costos, Utilidad"},{"id":"C", "texto":"Clientes, Proveedores, Estado"}], "respuesta_correcta":"A"}'::jsonb),
('PR', 'Administracion', 'sr', '¿Qué harías si tu principal proveedor sube los precios un 30% repentinamente?', '["Cadena de suministro", "Diversificación"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 80, "max_caracteres": 1000}'::jsonb),
('PR', 'Administracion', 'sr', 'Explica qué es el ROI y cómo se calcula.', '["Retorno de Inversión", "(Ganancia - Inversión) / Inversión"]'::jsonb, '{"tipo": "abierta_texto", "min_caracteres": 30, "max_caracteres": 300}'::jsonb),


-- 3. INGENIERÍA INFORMATICA (Código: PR)
